...
import com.maiworm.sushi.repository.CardapioRepository;
...
/**
 * REST controller for managing {@link com.maiworm.sushi.domain.Cardapio}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CardapioResource {
    ...
    public ResponseEntity<Cardapio> updateCardapio(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cardapio.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Cardapio> partialUpdateCardapio(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cardapio.getId().toString())
        );
    }
