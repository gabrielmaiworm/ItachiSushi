...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './yakisoba.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_YAKISOBA_LIST actions', async () => {
    ...
    it('dispatches FETCH_YAKISOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_YAKISOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_YAKISOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_YAKISOBA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_YAKISOBA actions', async () => {
      const expectedActions = [
        {
