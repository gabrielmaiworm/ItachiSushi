...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cardapio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDAPIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDAPIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDAPIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDAPIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDAPIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDAPIO actions', async () => {
      const expectedActions = [
        {
