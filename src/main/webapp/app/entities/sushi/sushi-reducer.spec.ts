...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sushi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUSHI_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUSHI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUSHI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUSHI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUSHI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUSHI actions', async () => {
      const expectedActions = [
        {
