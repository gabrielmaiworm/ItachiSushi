...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './makimono.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAKIMONO_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAKIMONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAKIMONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAKIMONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAKIMONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAKIMONO actions', async () => {
      const expectedActions = [
        {
