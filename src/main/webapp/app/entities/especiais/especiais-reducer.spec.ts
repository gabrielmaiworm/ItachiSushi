...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './especiais.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESPECIAIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESPECIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESPECIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESPECIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESPECIAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESPECIAIS actions', async () => {
      const expectedActions = [
        {
