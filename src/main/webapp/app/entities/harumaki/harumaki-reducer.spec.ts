...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './harumaki.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HARUMAKI_LIST actions', async () => {
    ...
    it('dispatches FETCH_HARUMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HARUMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HARUMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HARUMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HARUMAKI actions', async () => {
      const expectedActions = [
        {
