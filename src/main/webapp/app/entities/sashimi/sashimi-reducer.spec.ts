...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sashimi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SASHIMI_LIST actions', async () => {
    ...
    it('dispatches FETCH_SASHIMI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SASHIMI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SASHIMI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SASHIMI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SASHIMI actions', async () => {
      const expectedActions = [
        {
