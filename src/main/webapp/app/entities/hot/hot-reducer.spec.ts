...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOT_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOT actions', async () => {
      const expectedActions = [
        {
