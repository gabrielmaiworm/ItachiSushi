...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './temaki.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMAKI_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMAKI actions', async () => {
      const expectedActions = [
        {
