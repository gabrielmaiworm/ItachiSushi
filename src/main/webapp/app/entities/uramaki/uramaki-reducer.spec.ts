...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './uramaki.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_URAMAKI_LIST actions', async () => {
    ...
    it('dispatches FETCH_URAMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_URAMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_URAMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_URAMAKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_URAMAKI actions', async () => {
      const expectedActions = [
        {
