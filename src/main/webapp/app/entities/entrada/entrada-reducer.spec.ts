...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './entrada.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTRADA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTRADA actions', async () => {
      const expectedActions = [
        {
